...
let myVar; // abbiamo assegnato un tipo number al contenitore myVar che altrimenti avrebbe ricevuto il tipo "any" (da evitare)
...
console.log(additionWithChecks(3, 2));
const additionWithTS = (number1, number2) => {
...
let whatever2; // assegnazione di tipo composto derivante da Type Alias
...
myArray4.forEach(n => n === null || n === void 0 ? void 0 : n.trim()); // questo punto di domanda si riferisce ad un "optional chaining"
...
const U3 = {
    ...
    topic: [
        ...
        {
            weeklyTopics: ["React Intermediate", "Lifecycle Methods", "Router", "Testing"]
        },
        {
